      ...
      <div className="hidden lg:block">
        <div className="grid lg:grid-cols-2 items-center justify-center gap-16 mb-20">
          ...
          <div data-aos="fade-left" className="space-y-3">
            <div className="lg:gap-3 items-center">
              <div className="font text-xl text-gray-300 mb-3">
                <SpringyText text="01" />
              </div>
            ...
            <div className="text-gray-300 text-muted-main fluid-lg">
              ...
              <div>Stack/Tools : NextJs, TailwindCss, GSAP, AOS.js, Vercel</div>
            </div>
        ...
        <div className="grid lg:grid-cols-2 items-center justify-center gap-16 mb-20">
          <div data-aos="fade-right" className="space-y-3">
            <div className="lg:gap-3 items-center">
              <div className="font text-xl text-gray-300 text-end mb-3">
                <SpringyText text="02" />
              </div>
              <div className="font text-gray-100 font-bold text-3xl">
            ...
            <div className="text-gray-300 text-muted-main fluid-lg">
              ...
              <div>
                Stack/Tools : NextJs, TailwindCss, Firebase, Redux-toolkit,
                Vercel
              </div>
            </div>
            <div className="flex gap-5 items-center">
